        ...
        if (ImGui::BeginTabBar("MyTabBar", tab_bar_flags))
        {
            if (ImGui::BeginTabItem("Scene"))
            {
                ...
                if (ImGui::BeginTable("tex_props", 2, ImGuiTableFlags_SizingFixedFit | ImGuiTableFlags_NoBordersInBody))
                {
                    ...
                    static float clearColor[4] = {clearColorValues[0].r(), clearColorValues[0].g(),
                                                  clearColorValues[0].b(), clearColorValues[0].a()};
                    ...
                    if (ImGui::ColorButton(
                            "##clearColorBtn", ImVec4(clearColor[0], clearColor[1], clearColor[2], clearColor[3]),
                    ...
                    {
                        bool changedLive =
                            ImGui::ColorPicker4("##clearColorPicker", clearColor,
