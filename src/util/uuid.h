...
class UUID
{
  public:
    ...
    {
        return uuids::to_string(m_);
    }
    bool is_nil() const noexcept
    {
        return m_.is_nil();
    }
    uuids::uuid_version version() const noexcept
    {
        return m_.version();
    }
    uuids::uuid_variant variant() const noexcept
    {
        return m_.variant();
    }
    ...
    const uuids::uuid& value() const noexcept
    {
        return m_;
    }
...
{
    size_t operator()(const Engine::UUID& u) const noexcept
    {
        return std::hash<uuids::uuid>{}(u.value());
    }
};
